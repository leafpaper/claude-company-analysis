...
### ★★ v7.1 写法铁律（§七 是全报告 punch line，必须最好读）
- **全说人话 + 结论先行**：§七 标题用骨架人话版("公司在变好吗" / "价格给不给机会" / "兑现前扛得住吗" / "最终结论:是不是好公司?该不该买?该怎么办?")；每节第一行一句话结论。不写裸术语(状态后验/赔率/路径用大白话)。
- **正文无来源标签**(Rule 5 同管 §七)；一个论点一个数字，不重报。
- ★ Rule 6 三锚词「决策三元组」「行动档位」「证伪」**保留**(机械检查需要)，但用人话句子承载，不堆术语。
- §七 7.4 的"三分结论 / 行动档位 / 该等什么"将被 part1 抄成 §一「投资决断卡」，务必清晰可抄、说人话。

### §七 投资决策内核(★ v7.1 短合成)—— 必须出 Rule 6 三要素
- ★★ **7.1/7.2/7.3 只给一句话结论 + "详见 §四/五/六"，绝不复述前面已讲过的证据**(§四 4.11 已把状态讲透、§五 已把估值讲透、§六 已把风险讲透——§七 不重复)。**§七 的篇幅和重心全在 7.4。**
- ★ 7.1 公司在变好吗?(详见 §四 4.11)→ **只一句话** {↑确认/↑未确认/横/↓}
- ★ 7.2 价格贵不贵、给不给机会?(详见 §五)→ **只一句话** {便宜/合理/price-in/买完未来}
- ★ 7.3 兑现前扛得住吗?(详见 §六 6.4)→ **只一句话** {可承受/高尾险}
