...
description: |
  ...
  只做 5 项检查: §一 综合评分 vs §四 加权 / §一 决策结论 vs §七 7.4 / §五 DCF 假设
  vs §二 历史 / §一 Top 3 vs §六 快筛 / §八 舆情条数. 只读不改, 输出固定 schema.
  使用场景:
...
| 1.2 | §一 决策结论 vs §七 7.4 | 决策三元组 / 三分结论 / 行动档位 必须字节一致(§一 照抄 §七 7.4);不一致即 FAIL |
