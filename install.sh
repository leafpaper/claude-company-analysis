#!/bin/bash
#
# Claude Code 投资分析 Skill — 一键安装 (v8.5)
#
# 使用方法：
...
echo "================================================"
echo "  Claude Code — 投资分析 Skill 安装程序 v8.5"
...
# v8.5 期望: 6 phases + 10 agents + 9 refs + 33 scripts + 6 assets + 15 schemas + 1 SKILL.md
# (schemas 14→15: +change-baseline —— 「较上版变化」只按变化区块消费的字段校验上版节点)
